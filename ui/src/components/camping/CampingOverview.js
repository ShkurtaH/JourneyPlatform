            ...
            <div className="content w-bg single-bg" style={{ backgroundImage: `url("/assets/images/general/wilderness.jpg")` }}>
                <Container>
                    ...
                    <Breadcrumb className="breadcrumbs">
                        <Link to="/">Home</Link>
                        <Link to="/camping" className="active">Camping</Link>
                    </Breadcrumb>
                </Container>
            </div>
            <div className="content my-100">
                <Container>
                    <div className="text-center mb-5">
                        ...
                        <h1 className="main-title">Latest From Camping</h1>
                    </div>
                    <Row>
                        <Col xl={4} className="item">
                            <Card>
                                <div className="item-img-wrapper">
                                    <Card.Img variant="top" src="/assets/images/general/skiing.jpg" className="item-img" />
                                </div>
                                <Card.Body>
                                    ...
                                    <Card.Title>
                                        <Link to="/camping-detail" className="item-link">Travel Essentials</Link>
                                    </Card.Title>
                                    <Card.Text>
                                    ...
                                    <Link to="/camping-detail" className="main-btn">Read More</Link>
                                </Card.Body>
                        ...
                        <Col xl={4} className="item">
                            <Card>
                                ...
                                <Card.Body>
                                    ...
                                    <Card.Title>
                                        <Link to="/camping-detail" className="item-link">Best places to visit</Link>
                                    </Card.Title>
                                    <Card.Text>
                                        Cu eum alia elit, usu in eius appareat, deleniti sapientem honestatis eos ex. In ius esse ullum vidisse
                                        Cu eum alia elit, usu in eius appareat, deleniti sapientem honestatis eos ex. In ius esse ullum vidisse
                        ...
                        <Col xl={4} className="item">
                            <Card>
                                ...
                                <Card.Body>
                                    ...
                                    <Card.Title>
                                        <Link to="/camping-detail" className="item-link">Things to do</Link>
                                    </Card.Title>
                                    <Card.Text>
                                        Cu eum alia elit, usu in eius appareat, deleniti sapientem honestatis eos ex. In ius esse ullum vidisse
                                        Cu eum alia elit, usu in eius appareat, deleniti sapientem honestatis eos ex. In ius esse ullum vidisse
...
export default CampingOverview;